...
module.exports = (_ref, pluginOptions) => {
  let {
    ...
    reporter
      ...
      rest = (0, _objectWithoutPropertiesLoose2.default)(_ref, ["type", "basePath", "getNode", "getNodesByType", "cache", "getCache", "reporter"]);
      ...
      timeToRead: {
        ...
        resolve(markdownNode) {
          return getHTML(markdownNode).then(html => {
            ...
            const wordCount = _.words(pureText).length + _.words(pureText, /[\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u3005\u3007\u3021-\u3029\u3038-\u303B\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FD-\u30FF\u31F0-\u31FF\u32D0-\u32FE\u3300-\u3357\u3400-\u4DB5\u4E00-\u9FEF\uF900-\uFA6D\uFA70-\uFAD9\uFF66-\uFF6F\uFF71-\uFF9D\u{1B000}-\u{1B11E}\u{1B150}-\u{1B152}\u{1B164}-\u{1B167}\u{1F200}\u{20000}-\u{2A6D6}\u{2A700}-\u{2B734}\u{2B740}-\u{2B81D}\u{2B820}-\u{2CEA1}\u{2CEB0}-\u{2EBE0}\u{2F800}-\u{2FA1D}]/gu).length;
